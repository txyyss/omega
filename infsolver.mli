 ...
 sig 
  ...
  module IS : 
   sig 
    ...
    module IA : 
     sig 
      type coq_ZExp = SIM.InfS.IA.coq_ZExp =
      | ZExp_Var of Coq_sv.var
      | ZExp_Const of PureInfinity.N.coq_A
      | ZExp_Add of coq_ZExp * coq_ZExp
      | ZExp_Inv of coq_ZExp
      ...
      type coq_ZBF = SIM.InfS.IA.coq_ZBF =
      | ZBF_Const of Three_Val_NoneError.coq_Val
      | ZBF_Lt of coq_ZExp * coq_ZExp
      | ZBF_Lte of coq_ZExp * coq_ZExp
      | ZBF_Gt of coq_ZExp * coq_ZExp
      ...
      type coq_ZF = SIM.InfS.IA.coq_ZF =
      | ZF_BF of coq_ZBF
      | ZF_And of coq_ZF * coq_ZF
      | ZF_Or of coq_ZF * coq_ZF
      | ZF_Imp of coq_ZF * coq_ZF
    ...
    module FA : 
     sig 
      type coq_ZExp = SIM.InfS.FA.coq_ZExp =
      | ZExp_Var of Coq_sv.var
      | ZExp_Const of PureInt.N.coq_A
      | ZExp_Add of coq_ZExp * coq_ZExp
      | ZExp_Inv of coq_ZExp
      ...
      type coq_ZBF = SIM.InfS.FA.coq_ZBF =
      | ZBF_Const of Three_Val_NoneError.coq_Val
      | ZBF_Lt of coq_ZExp * coq_ZExp
      | ZBF_Lte of coq_ZExp * coq_ZExp
      | ZBF_Gt of coq_ZExp * coq_ZExp
      ...
      type coq_ZF = SIM.InfS.FA.coq_ZF =
      | ZF_BF of coq_ZBF
      | ZF_And of coq_ZF * coq_ZF
      | ZF_Or of coq_ZF * coq_ZF
      | ZF_Imp of coq_ZF * coq_ZF
    ...
    module I2F : 
     sig 
      type coq_ZExp = SIM.InfS.I2F.coq_ZExp =
      | ZExp_Var of Coq_sv.var
      | ZExp_Const of IntToInfinity.N.coq_A
      | ZExp_Add of coq_ZExp * coq_ZExp
      | ZExp_Inv of coq_ZExp
      ...
      type coq_ZBF = SIM.InfS.I2F.coq_ZBF =
      | ZBF_Const of Three_Val_NoneError.coq_Val
      | ZBF_Lt of coq_ZExp * coq_ZExp
      | ZBF_Lte of coq_ZExp * coq_ZExp
      | ZBF_Gt of coq_ZExp * coq_ZExp
      ...
      type coq_ZF = SIM.InfS.I2F.coq_ZF =
      | ZF_BF of coq_ZBF
      | ZF_And of coq_ZF * coq_ZF
      | ZF_Or of coq_ZF * coq_ZF
      | ZF_Imp of coq_ZF * coq_ZF
