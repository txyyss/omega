...
Module ArithSemantics (I : SEMANTICS_INPUT) (V : VARIABLE) (VAL : SEM_VAL) (L : LEQ_RELATION I.N VAL) (ZT : ZERO_PRODUCT I.N).
  ...
  Section DirectSemantics.
    ...
    Lemma sat_or_3: forall f1 f2, inputOrder (DisSat f1) (Sat (ZF_Or f1 f2)). smash. Defined.
    ...
    Lemma dst_and_3: forall f1 f2, inputOrder (Sat f1) (DisSat (ZF_And f1 f2)). smash. Defined.
    Lemma dst_and_4: forall f1 f2, inputOrder (Sat f2) (DisSat (ZF_And f1 f2)). smash. Defined.
    ...
    Proof.
      ...
      exfalso; apply (IHn zf1); intuition.
      ...
      destruct H0 as [[x ?] ?]; specialize (H1 x); apply (IHn (substitute (v, conv q x) zf));
      [rewrite <- substitute_length_inv|]; intuition.
    Qed.
